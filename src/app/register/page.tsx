  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-bg relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-accent/5 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md p-8 relative z-10">
        <div className="bg-panel border border-border shadow-2xl rounded-2xl p-8 space-y-8 animate-fade-in">
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-extrabold tracking-tight text-ink">Join Depictionator</h1>
            <p className="text-sm text-muted">Create your team's workspace</p>
          </div>
